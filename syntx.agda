...
weakenCommutesTm'old m k (suc u)
  ...
  = refl
weakenCommutesTm'old m k (natelim P d0 dS u)
  = {!!}
...
UnitR-is-Prop : (a : UnitR) → starU ≡R a
UnitR-is-Prop starU = reflR
