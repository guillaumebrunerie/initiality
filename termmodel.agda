...
UUStrNatSynCCat : CCatwithUUNat synCCat UUStrSynCCat
CCatwithUUNat.UUStrNat UUStrNatSynCCat {g = g} refl {g₁ = g₁} = UUStrNatS g _ g₁
...
ElStrSynCCat : CCatwithEl synCCat UUStrSynCCat UUStrNatSynCCat
...
ElStrNatS : {i : ℕ} (g : MorS n m) (Γ : ObS m) (v : MorS m (suc m)) (vₛ : S.is-section v) (v₁ : ∂₁S v ≡ UUStrS i Γ) (g₁ : ∂₁S g ≡ Γ)
  → S.star g (ElStrS i Γ v vₛ v₁) (ElStr=S i Γ v vₛ v₁) g₁ ≡ ElNatRHS ElStrSynCCat g refl v vₛ v₁ g₁ 
ElStrNatS = //-elimP (λ g → //-elimP (λ Γ → //-elimP (λ v vₛ v₁ g₁ → refl)))

ElStrNatSynCCat : CCatwithElNat synCCat UUStrSynCCat UUStrNatSynCCat ElStrSynCCat
CCatwithElNat.ElStrNat ElStrNatSynCCat {g = g} refl {g₁ = g₁} = ElStrNatS g _ _ _ _ g₁
...
PiStrNatS : (g : MorS n m) (Γ : ObS m) (A : ObS (suc m)) (A= : ftS A ≡ Γ) (B : ObS (suc (suc m))) (B= : ftS B ≡ A) (g₁ : ∂₁S g ≡ Γ)
          ...
          ≡ PiNatRHS PiStrSynCCat g refl A= B B= g₁
PiStrNatS = //-elimP (λ g → //-elimP (λ Γ → //-elimP (λ A A= → //-elimP (λ B B= g₁ → refl))))


PiStrNatSynCCat : CCatwithPiNat synCCat PiStrSynCCat
CCatwithPiNat.PiStrNat PiStrNatSynCCat {g = g} refl {g₁ = g₁} = PiStrNatS g _ _ _ _ _ g₁
...
-- CCatwithNat.NatStrNat NatStrSynCCat {g = g} refl {g₁ = g₁} = NatStrNatS g _ g₁
