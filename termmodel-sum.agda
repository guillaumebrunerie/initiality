...
sumStrS-// : (i : ℕ) (Γ : DCtx n)
           ...
           → DMor n (suc n)
sumStrS-// i Γ a aₛ a₁ b bₛ b₁ = dmorTm Γ (SumUU (dTm refl a aₛ a₁) (dTm refl b bₛ b₁))
...
inlStrS-// : (Γ : DCtx n)
           ...
           → DMor n (suc n)
inlStrS-// Γ A A= B B= a aₛ a₁ = dmorTm Γ (Inl (dTy A A=) (dTy B B=) (dTm A= a aₛ a₁))
...
inrStrS-// : (Γ : DCtx n)
           ...
           → DMor n (suc n)
inrStrS-// Γ A A= B B= b bₛ b₁ = dmorTm Γ (Inr (dTy A A=) (dTy B B=) (dTm B= b bₛ b₁))
...
matchStrS-// : (Γ : DCtx n)
             ...
             → DMor n (suc n)
matchStrS-// Γ A A= B B= C C= da daₛ da₁ db dbₛ db₁ u uₛ u₁ = dmorTm Γ (Match (dTy A A=) (dTy B B=) (dTy C C=) dda ddb (dTm refl u uₛ u₁))
