...
fixSubstTy : {X : TyExpr (suc n)}
           ...
           ≡ ((X [ weakenMor (weakenMor (idMor n)) , var last ]Ty) [ weakenMor (weakenMor (idMor _)) , var last ]Ty) [ idMor _ , suc (var (prev last)) ]Ty
...
natelimStrS-// Γ P P= dO dOₛ dO₁ dS dSₛ dS₁ u uₛ u₁ =
  let ddS : Derivable (((ctx Γ , nat) , getTy P) ⊢ getTm dS :> substTy (weakenTy' (prev last) (weakenTy' (prev last) (getTy P))) (suc (var (prev last))))
      ddS = congTmTy! fixSubstTy (dTm {Γ = (((_ , _) , _) , ((der Γ , Nat) , dTy P P=))} {A = starS-//-u
                                                                                                (sucStrS-// P {!ss-//-u!} {!!} {!!})
                                                                                                ((ctx
                                                                                                  (starS-//-u
                                                                                                   (dmor P (ftS-// P) (weakenMor (idMor (suc _)))
                                                                                                    (ConvMor (WeakMor (idMorDerivable (getdCtx P))) (CtxTy=Ctx' P)
                                                                                                     (CtxRefl (getdCtx P))))
                                                                                                   (((ctx Γ , nat) ,
                                                                                                     (getTy ((ctx Γ , nat) , (der Γ , Nat)) [ weakenMor (idMor _) ]Ty))
                                                                                                    ,
                                                                                                    ((der Γ , Nat) ,
                                                                                                     SubstTy (getdTy ((ctx Γ , nat) , (der Γ , Nat)))
                                                                                                     (ConvMor
                                                                                                      (ConvMor
                                                                                                       (WeakMor
                                                                                                        (idMorDerivable (getdCtx ((ctx Γ , nat) , (der Γ , Nat)))))
                                                                                                       (CtxTy=Ctx' ((ctx Γ , nat) , (der Γ , Nat)))
                                                                                                       (CtxRefl (getdCtx ((ctx Γ , nat) , (der Γ , Nat)))))
                                                                                                      (CtxRefl (der Γ , Nat))
                                                                                                      (reflectOb
                                                                                                       ((S.pp₁ ∙ CCatwithNat.NatStr= NatStrSynCCat) ∙
                                                                                                        ! (CCatwithNat.NatStr= NatStrSynCCat))))))
                                                                                                   ((S.pp₁ ∙ P=) ∙ ! (S.ft-star ∙ S.pp₀)))
                                                                                                  ,
                                                                                                  (getTy
                                                                                                   ((ctx
                                                                                                     (starS-//-u
                                                                                                      (dmor ((ctx Γ , nat) , (der Γ , Nat))
                                                                                                       (ftS-// ((ctx Γ , nat) , (der Γ , Nat))) (weakenMor (idMor _))
                                                                                                       (ConvMor
                                                                                                        (WeakMor
                                                                                                         (idMorDerivable (getdCtx ((ctx Γ , nat) , (der Γ , Nat)))))
                                                                                                        (CtxTy=Ctx' ((ctx Γ , nat) , (der Γ , Nat)))
                                                                                                      ...
                                                                                                      ((S.pp₁ ∙ CCatwithNat.NatStr= NatStrSynCCat) ∙
                                                                                                       ! (CCatwithNat.NatStr= NatStrSynCCat)))
                                                                                                     , (getTy P [ weakenMor+ (weakenMor (idMor _)) ]Ty))
                                                                                                    ,
                                                                                                    (der
                                                                                                     (starS-//-u
                                                                                                      (dmor ((ctx Γ , nat) , (der Γ , Nat))
                                                                                                     ...
                                                                                                     (ConvMor
                                                                                                      (ConvMor
                                                                                                       (WeakMor+ (getdTy ((ctx Γ , nat) , (der Γ , Nat)))
                                                                                                        (ConvMor
                                                                                                         (ConvMor
                                                                                                          (WeakMor
                                                                                                           (idMorDerivable (getdCtx ((ctx Γ , nat) , (der Γ , Nat)))))
                                                                                                       ...
                                                                                                       (der
                                                                                                        (starS-//-u
                                                                                                         ...
                                                                                                         ((S.pp₁ ∙ CCatwithNat.NatStr= NatStrSynCCat) ∙
                                                                                                          ! (CCatwithNat.NatStr= NatStrSynCCat)))))
                                                                                                      (reflectOb (S.qq₁ ∙ ! P=)))))
                                                                                                   [ weakenMor+ (weakenMor (idMor (suc _))) ]Ty))
                                                                                                 ,
                                                                                                 (der
                                                                                                  (starS-//-u
                                                                                                   (dmor P (ftS-// P) (weakenMor (idMor (suc _)))
                                                                                                    ...
                                                                                                    (WeakMor+
                                                                                                     ...
                                                                                                     (ConvMor
                                                                                                      (ConvMor (WeakMor (idMorDerivable (getdCtx P))) (CtxTy=Ctx' P)
                                                                                                       (CtxRefl (getdCtx P)))
                                                                                                      (CtxRefl (der P))
                                                                                                      (reflectOb ((S.pp₁ ∙ P=) ∙ ! (S.ft-star ∙ S.pp₀)))))
                                                                                                    (CtxRefl
                                                                                                     (der P ,
                                                                                                      SubstTy
                                                                                                      (getdTy
                                                                                                        ...
                                                                                                        (ConvMor
                                                                                                         ...
                                                                                                         (reflectOb
                                                                                                          ((S.pp₁ ∙ CCatwithNat.NatStr= NatStrSynCCat) ∙
                                                                                                           ! (CCatwithNat.NatStr= NatStrSynCCat))))))
                                                                                                      ((S.pp₁ ∙ P=) ∙ ! (S.ft-star ∙ S.pp₀)))))
                                                                                                   (reflectOb (S.qq₁ ∙ ! (S.ft-star ∙ S.qq₀))))))
                                                                                                ((CCatwithsuc.sucStr₁ sucStrSynCCat ∙
                                                                                                  ! (CCatwithNat.NatStrNat NatStrSynCCat (S.comp₀ ∙ S.pp₀)) ∙
                                                                                                  S.star-comp)
                                                                                                 ∙ ! (S.ft-star ∙ S.qq₀))} (eq (box (CtxSymm (CtxTy=Ctx P P=)))) dS dSₛ dS₁)
...
--       ddS' : Derivable (((ctx Γ' , nat) , getTy P') ⊢ getTm dS' :> substTy (weakenTy' (prev last) (weakenTy' (prev last) (getTy P'))) (suc (var (prev last))))
--       ddS' = congTmTy! fixSubstTy (dTm {Γ = (((_ , _) , _) , ((der Γ' , Nat) , dTy P' P'=))} (eq (box (CtxSymm (CtxTy=Ctx P' P'=)))) dS' dS'ₛ dS'₁)
--       ddS= : Derivable (((ctx Γ , nat) , getTy P) ⊢ getTm dS == getTm dS' :> substTy (weakenTy' (prev last) (weakenTy' (prev last) (getTy P))) (suc (var (prev last))))
