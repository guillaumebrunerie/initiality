...
id-right synCCat {f = f} p = {!id-rightS f!}
id-left synCCat {f = f} p = {!id-leftS f!}
...
star-id synCCat {X = X} {p = p} = {!star-idS X!}
qq-id synCCat {X = X} {p = p} = {!qq-idS X!}
...
ss-pp synCCat {f = f} p {f₁ = f₁} = {!ss-ppS f!}
ss-qq synCCat {f = f} {f₁ = f₁} = {!ss-qqS f!}
