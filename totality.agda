...
⟦⟧TmEq r {u = app A B (lam A B u) a} (Beta dA dB du da) (Aᵈ , Bᵈ , (_ , uᵈ , us , tt) , aᵈ , _ , u₁ , as , a₁ , tt) u'ᵈ =
  betaStr {us = us} {u₁ = ⟦⟧Tm₁ (respectsCtxExt r A) u du} {as = as} {a₁ = a₁ ∙ ap ft (! (⟦⟧Tm₁ (respectsCtxExt r A) u du))}
